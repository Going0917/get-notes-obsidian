...
# 可根据自己的工作场景自由扩充
_WORK_TAGS = {
    "工作", "work", "职场", "答辩", "晋升", "项目", "汇报", "okr", "kpi",
    "会议", "meeting", "周报", "月报", "复盘",
    "业务", "运营", "电商", "视频号", "投放", "广告", "商家", "直播",
    "品牌", "私域", "腾讯", "合作", "客户", "618", "Q3", "Q4",
    "增长", "营销", "商务", "团队",
    "华大", "华大营养", "诺特兰德", "星盟", "万益蓝", "万叶兰", "养元健",
    "养能健", "多燕瘦", "Swisse", "Swiss", "谷雨", "大健康", "营养",
    "保健品", "膳食", "益生菌", "公私域", "营销云", "智投", "GMV",
    "内容力", "商品力", "开品", "货架",
}
