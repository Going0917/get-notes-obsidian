...
- 通用笔记：`YYYY-MM-DD_标题.md`
- 语音日记：`YYYY-MM-DD_HHMM_语音日记.md`
...
- 公私域、营销云、直播加粉、私域投流 follow-up 类进入 `Working💻/06-with中台/公私域协同/`。
- 风控审核、功效标签、类目规则类进入 `Working💻/03-赛道行业/with 风控/` 或相关赛道目录。
- 小红书、外部内容、AI 工具文章不视为实际工作会议，按内容回到 `Get笔记沉淀/01_AI与科技`，不创建 Working 工作副本。
...
🚀 开始同步 12 条笔记...
  ...
  ✅ [2/12] voice    | 2026-03-11 | 2026-03-11_1435_语音日记.md
